...
# TRAIN_PARAMS="--train_bs 32 --test_bs 32 --save_total_limit 3 --weight_decay 0.001 --lr 2e-5 --num_epochs 1000 --gradient_accumulation_steps 1 --warmup_ratio 0.0 --dataloader_num_workers 8"
TRAIN_PARAMS="--train_bs 16 --test_bs 16 --save_total_limit 3 --weight_decay 0.001 --lr 2e-5 --num_epochs 1000 --gradient_accumulation_steps 1 --warmup_ratio 0.0 --dataloader_num_workers 8"
MODEL="--model_name microsoft/layoutlmv3-base --stride 0 --use_BIO_format --pretrained_weights /storage/table_extraction/pretrained_layoutlmv3_v2.ckpt "
# MODEL="--model_name microsoft/layoutlmv3-base --stride 0 --use_BIO_format --pretrained_weights /storage/table_extraction/pretrained_layoutlmv3_v1.ckpt "
...
# OUT_DIR="/storage/table_extraction/trainings/fullpage_multilabel/${DATASET}/LayoutLMv3_fromOurPretrained_v1/${TIMESTAMP}"
OUT_DIR="/storage/table_extraction/trainings/fullpage_multilabel/${DATASET}/LayoutLMv3_fromOurPretrained_v3/${TIMESTAMP}"
mkdir -p ${OUT_DIR}
